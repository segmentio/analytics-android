...
public class IntegrationManagerTest {
  ...
  @Test public void run() {
    ...
    TrackPayload trackPayload = new TrackPayloadBuilder().build();
  ...
  @Test public void runPayloadOperation() {
    ...
    GroupPayload groupPayload = new GroupPayloadBuilder().build();
  ...
  @Test public void trackWithoutPlan() throws IOException {
    TrackPayload trackPayload = new TrackPayloadBuilder().event("bar").build();
