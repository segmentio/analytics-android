...
/* package */final class DatapointHelper
{
     ...
     * <p>
     * Note: this method will return null if {@link android.Manifest.permission#READ_PHONE_STATE} is not available. This method will also return
     * null on devices that do not have telephony.
     *
     * @param context The context used to access the phone state.
     * @return An the {@link android.telephony.TelephonyManager#getDeviceId()}. Null if an ID is not available, or if
