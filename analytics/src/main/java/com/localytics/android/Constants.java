...
/* package */final class Constants {
  ...
  /**
   * Version number of this library. This number is primarily important in terms of changes to the
   * upload format.
   */
  //@formatter:off
    /*
   ...
   * <p>
   * For example, if the user opens an app, presses home, and opens the app again in less than this
   ...
   * <p>
   * Before releasing a production version of an app, this should be set to false for privacy and
  ...
  /**
   * Flag indicating whether uncaught exceptions should be suppressed. Analytics are secondary to
   * any other functions performed
   * by an app, which means that analytics should never cause an app to crash.
   * <p>
   * Normally this should be set to true. The only time this should be set to false is during
   * development on the Localytics
