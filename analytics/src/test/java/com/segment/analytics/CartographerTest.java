...
public class CartographerTest {
  ...
  @Test public void encodesPrimitives() throws IOException {
    Map<String, Object> map = ImmutableMap.<String, Object>builder().put("byte", (byte) 32)
        .put("boolean", true)
        .put("short", (short) 100)
        .put("int", 1)
        .put("long", 43L)
  ...
  @Test public void prettyPrintDisabled() throws IOException {
    ...
    Map<String, Object> map = ImmutableMap.<String, Object>builder().put("a",
        ImmutableMap.<String, Object>builder().put("b",
            ImmutableMap.<String, Object>builder().put("c",
                ImmutableMap.<String, Object>builder().put("d",
                    ImmutableMap.<String, Object>builder().put("e", "f").build()).build()).build())
            .build()).build();
  ...
  @Test public void decodesNestedMaps() throws IOException {
    ...
    Map<String, Object> map = cartographer.fromJson(json);
    Map<String, Object> expected = ImmutableMap.<String, Object>builder().put("a",
        ImmutableMap.<String, Object>builder().put("b",
            ImmutableMap.<String, Object>builder().put("c",
                ImmutableMap.<String, Object>builder().put("d",
                    ImmutableMap.<String, Object>builder().put("e", "f").build()).build()).build())
  ...
  @Test public void encodesArrayOfMap() throws IOException {
    Map<String, Object> map = ImmutableMap.<String, Object>builder().put("a",
        Arrays.<ImmutableMap>asList(ImmutableMap.<String, Object>builder().put("b", "c").build(),
            ImmutableMap.<String, Object>builder().put("b", "d").build(),
            ImmutableMap.<String, Object>builder().put("b", "e").build())).build();
